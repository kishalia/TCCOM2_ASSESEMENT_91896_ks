...
At the beginning of the program,a prompt will ask how many questions you would like to answer. 
Please enter how questions you have. The program will repeat the next steps the number of times 
depending on how many questions you have.The code will ask you to choose which calculations you would like to perform 
by choosing the corresponding number to the calculation. Please enter the number that you like to be displayed.
The code will then ask if you would like to perform any other calculations. If you would like to,please
enter "yes" and then choose another number. Do this until all the calculations you need are included.
